...
export const useSettingsStore = defineStore('settings', () => {
  ...
  async function save() {
    const data = {
      ...
      asrAppId: asrAppId.value, asrApiKey: asrApiKey.value,
  ...
  async function setAsrConfig(appId, apiKey) { asrAppId.value = appId; asrApiKey.value = apiKey; await save() }
  ...
  return {
    deepseekApiKey, deepseekModel, asrAppId, asrApiKey,
